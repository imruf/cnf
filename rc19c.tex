...
\newcommand{\fileno}{\ssmlf}

\newcommand{\impn}{\ssml}
\newcommand{\impadd}{\ssmla}
\newcommand{\impreg}{\ssmlreg}

\newcommand{\beno}{C-424485}
\newcommand{\bedt}{01/03/2022}

\newcommand{\stc}{STC:2,950.00 BALES}
...
\newcommand{\depo}{PORT LINK,DEPOT, CHITTAGONG}

%\newcommand{\rdepo}{... ... ... ... ... ... ... ... ... ..., DEPOT, CHITTAGONG}
\newcommand{\rdepo}{KDS,DEPOT, CHITTAGONG}


\newcommand{\vessel}{SOL DELTA}
\newcommand{\blno}{EGLV100270003892}
\newcommand{\bldt}{}
\newcommand{\rotno}{2022/1091}

%\newcommand{\rno}{R-\hspace{10em}}
\newcommand{\rno}{R-455789}

%\newcommand{\rdt}{\hspace{2em}-03-2022}
\newcommand{\rdt}{03-03-2022}

\newcommand{\rodt}{তারিখ: \hspace{2.0em}/০৩/২০২২ ইং}
\newcommand{\robdt}{\hspace{2.0em}/০৩/২০২২ ইং}
\newcommand{\letterdt}{তারিখ: \hspace{3.0em}/০৩/২০২২ ইং}
\newcommand{\frbdt}{তারিখ: \hspace{2.4em}/০৩/২০২২}
\newcommand{\fdt}{\hspace*{3em} তারিখ: \hspace{2.4em}/০৩/২০২২}

%\newcommand{\riskbonddate}{\hspace{2em}/০৩/২০২২ খ্রি:}
\newcommand{\riskbonddate}{ ০৬/০৩/২০২২ খ্রি:}

\newcommand{\riskbondno}{......................}
%\newcommand{\riskbondno}{}

\newcommand{\riskbondtk}{৩০,৪০,০০০/-}
\newcommand{\riskbondtkg}{১০০০/-}

%\newcommand{\san}{... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...}
\newcommand{\san}{\baridhi}

%\newcommand{\sad}{... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...}
\newcommand{\sad}{\baridhia}

%\newcommand{\conno}{$\boldsymbol{1\times 20^\prime\hspace{0.2em}\&\hspace{0.2em}06\times 40^\prime}$}

\newcommand{\conno}{$\boldsymbol{19\times 40^\prime}$}
...
\hline
\textbf{FCIU9281444}{\condf}
&
\textbf{TCNU3114070}{\condf}
&
\textbf{TEMU8665585}{\condf}
&
\textbf{EITU1186418}{\condf}
&
\textbf{EITU1648840}{\condf}
\\
\hline
\textbf{GAOU6414143}{\condf}
&
\textbf{TCNU2264219}{\condf}
&
\textbf{BSIU8113079}{\condf}
&
\textbf{DFSU6913485}{\condf}
&
\textbf{TEMU8686588}{\condf}
\\
\hline
\textbf{EGHU9354733}{\condf}
&
\textbf{EGHU9723493}{\condf}
&
\textbf{TLLU5416403}{\condf}
&
\textbf{EGHU9476161}{\condf}
&
\textbf{EITU1899492}{\condf}
\\
\hline
\textbf{HMCU9056356}{\condf}
&
\textbf{BEAU5192454}{\condf}
&
\textbf{EMCU9791110}{\condf}
&
\textbf{TCLU9326423}{\condf}
&
\textbf{}
\\
\hline
