...
\newcommand{\fileno}{নথি নং - ৩৮৫৯/এপি/সেকশন-৪/২০২১-২০২২}
\newcommand{\beno}{C-236173}
\newcommand{\bedt}{03.02.2022}
\newcommand{\menifest}{2022/549}
\newcommand{\lcno}{0000229422230001}
\newcommand{\lcdt}{03.01.2022}
\newcommand{\lienbank}{FIRST SECURITY ISLAMI BANK LTD.}
\newcommand{\lcano}{2935}
\newcommand{\lcadt}{{\lcdt}}
\newcommand{\invno}{5960002299}
\newcommand{\invdt}{16.01.2022}
\newcommand{\blno}{PKGA38460}
\newcommand{\bldt}{16.01.2022}
\newcommand{\good}{VISCOSE RAYON STAPLE FIBER}
\newcommand{\pkg}{870.00 BALE}
\newcommand{\product}{}
\newcommand{\crf}{NON CRF}
\newcommand{\crfdt}{}
\newcommand{\hscode}{55041000}
\newcommand{\price}{US\$ 539,311.84}
...
\newcommand{\musokr}{}
\newcommand{\btmaltno}{প্রত্যয়ন পত্র নং- }
\newcommand{\btmaltnodt}{তারিখ:  খ্রি:}

\newcommand{\cashtotal}{৩৯,২৪০.৭৯ (ঊনচল্লিশ হাজার দুইশত চল্লিশ টাকা ঊনআশি পয়সা)}

\newcommand{\rodt}{তারিখ: \hspace{2.0em}/০২/২০২২ ইং}
\newcommand{\fdt}{\hspace*{3em} তারিখ: \hspace{2.2em} /০২/২০২২}

\newcommand{\allotment}{৭৫০০}
\newcommand{\relesed}{১৩০.০৬৫৯}
\newcommand{\current}{২৬৯.৬৪৮৯}
\newcommand{\remaining}{৭৩৬৯.৯৩৪১}
\newcommand{\balance}{৭১০০.২৮৫২}
...
{\allotment} মে.টন।
ইতিপূর্বে বি/ই নং
C-236092, DT: 03.02.2022
এর মাধ্যমে ছাড় করা হয়
{\relesed} মে.টন।
অবশিষ্ট আছে
