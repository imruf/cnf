...
{\btmaltnodt} নথির যোগাযোগ অংশে রক্ষিত
...
ডি এফ ভ্যাট বাবদ ৪১,০৬১,.৭২ (একচল্লিশ হাজার একষট্টি টাকা বাহাত্তর পয়সা) টাকা
...
হইলে অঙ্গীকারনামা ফেরতযোগ্য হইবে। উল্লেখ্য আবেদনকারী
উপকরণের প্রক্কলন দাখিল করা হয়েছে, যা নথির যোগাযোগ
অংশে রক্ষিত আছে।
\end{minipage}
\begin{minipage}[t]{0.05\linewidth}
\hspace{1em}
...
\end{minipage}
\begin{minipage}[t]{0.90\linewidth}
বার্ষিক প্রাপ্যতার পরিমান
{\allotment} মে.টন।
ইতিপূর্বে ছাড় করা হয়েছে
{\relesed} মে.টন।
অবশিষ্ট আছে
