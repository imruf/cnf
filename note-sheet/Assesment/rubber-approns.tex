...
\newcommand{\fileno}{নথি নং - ২২৬৬/এপি/সেকশন-৭(বি)/২০২১-২০২২}
...
\newcommand{\product}{}
\newcommand{\good}{RUBBER APRONS}
\newcommand{\pkg}{77.00 CARTON=917.70 KGS}
\newcommand{\co}{INDIA}
\newcommand{\coship}{INDIA}
\newcommand{\vessel}{SAN ALFONSO}
\newcommand{\blno}{TML58873CTG1021}
\newcommand{\bldt}{02.11.2021}
\newcommand{\beno}{C-1945083}
\newcommand{\bedt}{02.12.2021}
\newcommand{\lcno}{0000174121010678}
\newcommand{\lcdt}{19.09.2021}
\newcommand{\lcano}{268815}
\newcommand{\lcadt}{\lcdt}
\newcommand{\lienbank}{MERCANTILE BANK LTD.}
\newcommand{\invno}{BE1291}
\newcommand{\invdt}{30.09.2021}
\newcommand{\ssml}{SHAMEEM SPINNING MILLS LTD.}
\newcommand{\ssmla}{SHAFIPUR, KALIAKAIR
\\
GAZIPUR-1751, BANGLADESH.}
\newcommand{\ssmlasl}{SHAFIPUR, KALIAKAIR,
GAZIPUR-1751, BANGLADESH.}
...
\newcommand{\jsmlaus}{JAMUNA SPINNING MILLS LTD. U-2,
BEJURA, SOUTH BEJURA,
MADHABPUR, HOBIGONJ-3331}
...
\newcommand{\impaddsl}{\ssmlasl}
\newcommand{\impbin}{000149603-0103}
...
\newcommand{\hscode}{4016.99.10}
\newcommand{\price}{US\$ 19,186.60}
\newcommand{\menifest}{2021/5298}
...
\newcommand{\btmaltno}{পত্র নং- ২৮৫৭১}
\newcommand{\btmaltnodt}{তারিখ: ২৩/১১/২০২১ খ্রি:}
...
এসোসিয়েশনের দাখিলকৃত প্রত্যয়নপত্র-২৮৩৯১
তারিখ: ১০/১১/২০২১ ইং নথির যোগাযোগ অংশে রক্ষিত
