...
%\newcommand{\fileno}{নথি নং- \hspace{15em}}
\newcommand{\fileno}{\jealf}
...
\newcommand{\jdlf}{নথি নং- এস-৫-২৪৫/স্টাফ/কাস/২০০৬-২০০৭/অংশ-২}
...
\newcommand{\impn}{\jeal}
\newcommand{\impadd}{SINABHA, KALIAKAIR, GAZILUR-1750}
...
\newcommand{\letterdt}{তারিখ: \hspace{3.0em}/১২/২০২১ ইং}
\newcommand{\conn}{] FCL Container}
\newcommand{\cond}{$\boldsymbol{\times 20^\prime}$}
\newcommand{\condf}{$\boldsymbol{\times 40^\prime}$}
\newcommand{\condn}{$\boldsymbol{\times 20^\prime\hspace{0.2em}\&\hspace{0.2em}01\times 40^\prime}$}
\newcommand{\riskbondno}{২৬২৬৮}
\newcommand{\riskbonddate}{ ০৮/১২/২১ খ্রি:}
\newcommand{\riskbondt}{৭,৬০,০০০/-}
\newcommand{\riskbondg}{৫০০/-}
\newcommand{\consh}{
\begin{tabular}{|l|l|l|l|}
\hline
\textbf{TEMU0692413}{\cond}
&
\textbf{HASU1124640}{\cond}
&
\textbf{MRKU9838908}{\cond}
&
\textbf{MRKU8300950}{\cond}
\\
\hline
\textbf{SUDU7483419}{\cond}
&
\textbf{SUDU7715279}{\cond}
&
\textbf{UXXU4316525}{\condf}
&
\textbf{}
\\
\hline
...
\textbf{\footnotesize{আমদানিকৃত ও শুল্কায়িত
[{\pack}, {\good}]
C/O. {\co}
হতে মালামালসহ
% container
...
জেটি কাস্টম ও এআইআর কর্তৃক শতভাগ কায়িক
পরীক্ষা করা হয়।
কায়িক পরীক্ষার প্রতিবেদনের আলোকে বি/ই এর
ক্রমিক নং -১, ১৩, ১৪, ও ১৫ নং আইটেম
খালাসকালে জেটিতে স্কেলে ওজন
করে সঠিক প্রাপ্তি সাপেক্ষে ছাড়যোগ্য।
পণ্যচালান
...
\end{minipage}
\begin{minipage}[t]{0.96\linewidth}
বিষয়:\hspace{1em}\textbf{আমদানিকৃত ও শুল্কায়িত
[{\pack}, {\good}]
C/O. {\co}
হতে মালামালসহ
% container
...
কায়িক পরীক্ষার প্রতিবেদনের আলোকে বি/ই এর
ক্রমিক নং -১, ১৩, ১৪, ও ১৫ নং আইটেম
খালাসকালে জেটিতে স্কেলে ওজন করে
সঠিক প্রাপ্তি সাপেক্ষে ছাড়যোগ্য।
পণ্যচালান
কন্টেইনার বন্দর জেটি
হতে স্থানান্তর কালে স্থায়ী
আদেশ নং-০২, তারিখ: ২৯/০৮/২০১৯ ইং
