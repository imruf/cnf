...
\newcommand{\bldt}{DT:12.10.21}
\newcommand{\rno}{\hspace{7em} / \hspace{4em}}
\newcommand{\rdt}{01-12-21}
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{MSKU7233988}{\cond}
&
\textbf{TGHU1636191}{\cond}
&
\textbf{MSKU7439958}{\cond}
\\
\hline
\end{tabular}
}
...
\footnotesize{রিস্ক বন্ড নং - ২৫১৫০৬}
\end{minipage}
\begin{minipage}[t]{.74\linewidth}
\footnotesize{{\fileno}}
\end{minipage}
\begin{minipage}[t]{.26\linewidth}
\footnotesize{\hspace{2.5em}তারিখ: ০১/১২/২০২১}
\\
\end{minipage}
\footnotesize{বরাবরে
\\
