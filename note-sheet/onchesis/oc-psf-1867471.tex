...
\newcommand{\beno}{C-1867471}
\newcommand{\bedt}{21.11.2021}
\newcommand{\rotno}{2021/5437}
\newcommand{\pack}{STC:1480 Bales}
\newcommand{\conno}{$\boldsymbol{20}$}
\newcommand{\co}{Thailand}
\newcommand{\vessel}{MAERSK HAI PHONG}
\newcommand{\fdt}{\hspace*{3em} তারিখ: \hspace{2.4em} /১১/২১}
\newcommand{\frbdt}{তারিখ: \hspace{2.4em} /১১/২১}
\newcommand{\good}{100 PCT POLYESTER STAPLE FIBER}
\newcommand{\depo}{Port Link Logistics Centre Limited, DEPOT, CHITTAGONG}
\newcommand{\rdepo}{..................................., DEPOT, CHITTAGONG}
\newcommand{\blno}{214091520}
\newcommand{\bldt}{}
\newcommand{\rno}{\hspace{7em} / \hspace{4em}}
\newcommand{\rdt}{\hspace{2em}-11-21}
...
\newcommand{\impreg}{\hspace{10em} তারিখ: \hspace{5em}}
\newcommand{\san}{MCC Transport(MAERSK BANGLADESH LIMITED}
...
\newcommand{\letterdt}{তারিখ: \hspace{3.0em}/১১/২০২১ ইং}
\newcommand{\conn}{HQ] FCL Container}
\newcommand{\cond}{$\boldsymbol{\times 40^\prime}$}
% \newcommand{\cond}{$\boldsymbol{\times 40^\prime\hspace{1em}\&\hspace{1em}05\times 40^\prime}$}
\newcommand{\riskbondt}{৩২,০০০০০/-}
\newcommand{\riskbondg}{১০০০/-}
\newcommand{\consh}{
\noindent{
\begin{tabular}{|l|l|l|l|l|}
\hline
\textbf{MRSU4664072}{\cond}
&
\textbf{MRSU4659414}{\cond}
&
\textbf{MRSU5251026}{\cond}
&
\textbf{MRSU4284745}{\cond}
&
\textbf{BEAU6377637}{\cond}
\\
\hline
\textbf{TCKU6718104}{\cond}
&
\textbf{CAAU6469313}{\cond}
&
\textbf{TCKU7859787}{\cond}
&
\textbf{MRSU5204873}{\cond}
&
\textbf{SEKU4449462}{\cond}
\\
\hline
\textbf{MRSU5251664}{\cond}
&
\textbf{MRSU5318120}{\cond}
&
\textbf{MRSU4729580}{\cond}
&
\textbf{MRSU4724736}{\cond}
&
\textbf{TRHU5206190}{\cond}
\\
\hline
\textbf{MRSU5251643}{\cond}
&
\textbf{MRSU5251601}{\cond}
&
\textbf{TRHU5665163}{\cond}
&
\textbf{TCNU1933027}{\cond}
&
\textbf{TCKU7801640}{\cond}
\\
\hline
\end{tabular}
}
...
\\
\end{minipage}
\footnotesize{উপর্যুক্ত বিষয়ে আপনার পত্র নং-নাই,
{\letterdt}
এর প্রেক্ষিতে জানানো যাচ্ছে যে, সংশ্লিষ্ট
\textbf{Shipping Agent: {\san}},
{\sad}
কর্তৃক অনাপত্তি প্রদান করায় এবং সংশ্লিষ্ট
শুল্কায়ন সেকশন কর্তৃক পণ্যচালানটি শুল্কায়নের
...
\scriptsize{আমদানিকৃত আলোচ্য চালানের পণ্য এসি জেটি মহোদয়ের উপস্থিতিতে ১০০\% কায়িক পরীক্ষা করা হয়। পণ্যচালান
...
\hspace*{2.4em}\footnotesize{(মোঃ জাহিদুল ইসলাম জামাল)}
\\
\hspace*{3.0em}\footnotesize{রাজস্ব কর্মকর্তা (স্টাফ শাখা)}
\\
...
\scriptsize{{\robdt}}
\\
\hspace*{3.2em}\footnotesize{(মোঃ জাহিদুল ইসলাম জামাল)}
\\
\hspace*{3.0em}\footnotesize{রাজস্ব কর্মকর্তা (স্টাফ শাখা)}
\\
\scriptsize{সহকারী/ডেপুটি কমিশনার অব কাস্টমস এর পক্ষে}
...
\framebox[1.02\width]{FACTORY:{\impadd}}
\\
\framebox[1.02\width]{ছাড়কারী:{\cnfn},{\cnfadd}}}
\\
\end{minipage}
\begin{minipage}[t]{0.04\linewidth}
\hspace{0.0em}
...
(ক)
\end{minipage}
আমদানিকৃত আলোচ্য চালানের পণ্য এসি জেটি মহোদয়ের উপস্থিতিতে ১০০\% কায়িক পরীক্ষা করা হয়। পণ্যচালান
কন্টেইনারসহ বেসরকারি ডিপো
{\depo}
হতে স্থানান্তর কালে স্থায়ী
আদেশ নং-৯৬, তারিখ: ১০-১২-২০১৪ ইং
