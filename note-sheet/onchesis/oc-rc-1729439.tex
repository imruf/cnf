...
\newcommand{\pack}{STC:435 BALES}
\newcommand{\good}{RAW COTTON}
\newcommand{\co}{Cote d'Ivoire}
\newcommand{\depo}{QNS Container Services Limited, DEPOT, CHITTAGONG}
\newcommand{\rdepo}{..................................., DEPOT, CHITTAGONG}
\newcommand{\vessel}{MV.X-PRESS KOHIMA}
\newcommand{\rotno}{2021/4906}
\newcommand{\blno}{20210945}
\newcommand{\beno}{C-1729439}
\newcommand{\bedt}{28.10.2021}
\newcommand{\rno}{\hspace{7em} / \hspace{4em}}
\newcommand{\rdt}{\hspace{2em}-11-21}
\newcommand{\conno}{$\boldsymbol{04}$}
...
\hline
\textbf{FBLU0045939}{\cond}
&
\textbf{SEGU5494081}{\cond}
&
\textbf{TCNU1366279}{\cond}
&
\textbf{TRLU7071976}{\cond}
\\
\hline
\end{tabular}
}
...
উল্লেখ্য, রিস্ক বন্ডে- ৬,৬৪,০০০/- টাকার
