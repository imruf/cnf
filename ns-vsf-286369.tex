...
\newcommand{\fileno}{নথি নং - ৩৯৬৮/এপি/সেকশন-৪/২০২১-২০২২}
\newcommand{\beno}{C-286369}
\newcommand{\bedt}{10.02.2022}
\newcommand{\menifest}{2022/733}
...
\newcommand{\invno}{5960002320}
\newcommand{\invdt}{22.01.2022}
\newcommand{\blno}{SINA161315}
\newcommand{\bldt}{22.01.2022}
\newcommand{\good}{VISCOSE RAYON STAPLE FIBER}
\newcommand{\pkg}{450.00 BALE = 139.345.50 KGS}
\newcommand{\product}{}
\newcommand{\crf}{NON CRF}
\newcommand{\crfdt}{}
\newcommand{\hscode}{55041000}
\newcommand{\price}{US\$ 277,446.39}
\newcommand{\co}{INDONESIA}
\newcommand{\coship}{INDONESIA}
\newcommand{\vessel}{KOTA BUANA}
...
\newcommand{\musokr}{}
\newcommand{\btmaltno}{প্রত্যয়ন পত্র নং- ২৯১৯৯}
\newcommand{\btmaltnodt}{তারিখ:  ০১/০২/২০২২ খ্রি:}

\newcommand{\cashtotal}{২৫,৫৫১.৬৩ (পঁচিশ হাজার পাঁচশত একান্ন টাকা তেষট্টি পয়সা)}

\newcommand{\rodt}{তারিখ: \hspace{2.0em}/০২/২০২২ ইং}
\newcommand{\fdt}{\hspace*{3em} তারিখ: \hspace{2.2em} /০২/২০২২}

\newcommand{\allotment}{৭৫০০}
\newcommand{\relesed}{৩৯৯.৭১৪৮}
\newcommand{\current}{১৩৯.৩৪৫৫}
\newcommand{\remaining}{৭১০০.২৮৫২}
\newcommand{\balance}{৬৯৬০.৯৩৯৭}
