...
\newcommand{\fileno}{নথি নং - \hspace{4em}/এপি/সেকশন-৪/২০২১-২০২২}
\newcommand{\beno}{C-209501}
\newcommand{\bedt}{31.01.2022}
\newcommand{\menifest}{2022/560}
\newcommand{\lcno}{0000229421230004}
\newcommand{\lcdt}{22.12.21}
\newcommand{\lienbank}{FIRST SECURITY ISLAMI BANK LTD.}
\newcommand{\lcano}{2932}
\newcommand{\lcadt}{{\lcdt}}
\newcommand{\invno}{1212193}
\newcommand{\invdt}{31.12.2021}
\newcommand{\blno}{COAU7236208790}
\newcommand{\bldt}{09.01.2022}
\newcommand{\good}{POLYESTER STAPLE FIBER}
\newcommand{\pkg}{1,320 BALE}
\newcommand{\product}{}
\newcommand{\crf}{NON CRF}
\newcommand{\crfdt}{}
\newcommand{\hscode}{55032000}
\newcommand{\price}{US\$ 628,338.22}
...
\newcommand{\ircno}{\scmlirc}
\newcommand{\ircrenewdt}{৩০/০৬/২০২২}
\newcommand{\musokr}{}
\newcommand{\btmaltno}{প্রত্যয়ন পত্র নং- ২৯০৫৮}
\newcommand{\btmaltnodt}{তারিখ:  ১৬/০১/২০২২ খ্রি:}
\newcommand{\rodt}{তারিখ: \hspace{2.0em}/১২/২০২১ ইং}

\newcommand{\fdt}{\hspace*{3em} তারিখ: \hspace{2.4em} /০১/২২}

\newcommand{\allotment}{৬৯৬.৭২}
\newcommand{\relesed}{২০৩.১৩২}
\newcommand{\current}{১০১.৫৩}
\newcommand{\remaining}{৪৯৩.৫৮৮}
\newcommand{\balance}{৩৯২.০৫৮}
...
আমদানি করা হয়েছে। পণ্যের স্বাভাবিক শুল্কহার-৫\%।
ইন্ডাস্ট্রির ক্ষেত্রে এসআরও অনুযায়ী উল্লিখিত
৫\% শুল্ক হতে ০\% করা হয়েছে।
\end{minipage}
\begin{minipage}[t]{0.05\linewidth}
\hspace{1em}
\end{minipage}
...
\end{minipage}
\begin{minipage}[t]{0.90\linewidth}
{\srootz}, {\srootzd} মোতাবেক
৪৯,৩৪০.৪১ (ঊনপঞ্চাশ হাজার তিনশত চল্লিশ টাকা একচল্লিশ পয়সা)
টাকা নগদে
...
{\allotment} মে.টন।
ইতিপূর্বে
বি/ই নং C-1765510 তারিখ: ০৩/১১/২০২১
এর মাধ্যমে ৫০.৩৫৩ মে.টন
এবং বি/ই নং C-1765539 তারিখ: ০৩/১১/২১
এর মাধ্যমে ১৫২.৭৭৯ মে.টন
মোট (৫০.৩৫৩+১৫২.৭৭৯) মে.টন={\relesed} মে.টন
ছাড় করা হয়। অবশিষ্ট আছে
