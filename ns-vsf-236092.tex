...
\newcommand{\fileno}{নথি নং - ৩৮৬০/এপি/সেকশন-৪/২০২১-২০২২}
\newcommand{\beno}{C-236092}
\newcommand{\bedt}{03.02.2022}
\newcommand{\menifest}{2022/550}
\newcommand{\lcno}{0000229422230002}
\newcommand{\lcdt}{03.01.2022}
\newcommand{\lienbank}{FIRST SECURITY ISLAMI BANK LTD.}
\newcommand{\lcano}{2934}
\newcommand{\lcadt}{{\lcdt}}
\newcommand{\invno}{5960002307}
\newcommand{\invdt}{18.01.2022}
\newcommand{\blno}{SINA160756}
\newcommand{\bldt}{18.01.2022}
\newcommand{\good}{VISCOSE RAYON STAPLE FIBER}
\newcommand{\pkg}{420.00 BALE}
\newcommand{\product}{}
\newcommand{\crf}{NON CRF}
\newcommand{\crfdt}{}
\newcommand{\hscode}{55041000}
\newcommand{\price}{US\$ 258,069.44}
\newcommand{\co}{INDONESIA}
\newcommand{\coship}{INDONESIA}
\newcommand{\vessel}{MV.GREEN EARTH}
...
\newcommand{\musokr}{}
\newcommand{\btmaltno}{প্রত্যয়ন পত্র নং- ২৯১৩০}
\newcommand{\btmaltnodt}{তারিখ:  ২৫/০১/২০২২ খ্রি:}

\newcommand{\cashtotal}{২৪,০২৩.৩১ (চব্বিশ হাজার তেইশ টাকা একত্রিশ পয়সা)}
...
\newcommand{\relesed}{}
\newcommand{\current}{১৩০.০৬৫৯}
\newcommand{\remaining}{}
\newcommand{\balance}{৭৩৬৯.৯৩৪১}
...
ধর্তব্যযোগ্য অপব্যববহার পাওয়া গেলে
...
{\allotment} মে.টন।
বর্তমান চালানের পণ্য {\current}
মে.টন ছাড় করা হলে
অবশিষ্ট থাকবে
({\allotment}-{\current}) মে.টন={\balance} মে.টন।
\\
\end{minipage}
\begin{minipage}[t]{0.05\linewidth}
\hspace{1em}
