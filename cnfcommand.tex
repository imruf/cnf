...
\newcommand{\cblf}{নথি নং- এস-৫-১৬১/স্টাফ/কাস/২০০৮-০৯/অংশ-১}
...
\newcommand{\bscargo}{BS SHIPPING LINES LIMITED}
\newcommand{\bscargoa}{BLOCK G, ROAD NO. 2, PLOT NO. 4, LANE NO. 4, HALISHAHAR HOUSING ESTATE CHITTAGONG, BANGLADESH​}
\newcommand{\pil}{PIL (BANGLADESH) LTD.}
\newcommand{\pila}{IIUC TOWER (5TH FLOOR), PLOT \# 09, SK. MUJIB ROAD, AGRABAD, CTG.}
\newcommand{\everbest}{EVERBEST LOGISTICS LTD.}
\newcommand{\everbesta}{AKHTARUZZAMAN CENTER (LEVEL 9), AGRABAD, CHITTAGONG.}
...
\newcommand{\fsen}{FIRST SCHEDULE AND EXPLANATORY NOTES}
