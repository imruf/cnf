...
আলোচ্য পণ্যচালানটির ১০০\% কায়িক পরীক্ষা করা হয়। কায়িক পরীক্ষায় ঘোষণা
মোতাবেক সঠিক পণ্য পাওয়া যায়।
কায়িক পরীক্ষার পরীক্ষার প্রতিবেদন অনলাইনে দেখা যেতে পারে।
\\
\end{minipage}
\begin{minipage}[t]{0.05\linewidth}
\hspace{1em}
...
এর বিধি-৪ অনুযায়ী পণ্যচালানটির আইটেম নং- ১ ও ৫ অনুযায়ী
পণ্যচালানটির আইটেম নং- ২, ৩, ৪ প্রস্তাবিত মূল্যে শুল্কায়নযোগ্য।
\\
\end{minipage}
\begin{minipage}[t]{0.05\linewidth}
% at
