...
\newcommand{\fileno}{নথি নং- এস \hspace{3em}/স্টাফ/কাস/\hspace{5em}/অংশ-}
...
\newcommand{\beno}{C-1956660}
\newcommand{\bedt}{04.12.2021}
\newcommand{\rotno}{2021/5659}
\newcommand{\pack}{STC:1400 BALES}
\newcommand{\conno}{$\boldsymbol{09}$}
\newcommand{\co}{INDIA}
\newcommand{\vessel}{HR SAHARE}
\newcommand{\fdt}{\hspace*{3em} তারিখ: \hspace{2.4em} /১২/২১}
\newcommand{\frbdt}{তারিখ: \hspace{2.4em} /১২/২১}
\newcommand{\good}{RAW COTTON}
\newcommand{\depo}{Esack Brothers Industries Limited, DEPOT, CHITTAGONG}
\newcommand{\rdepo}{..................................., DEPOT, CHITTAGONG}
\newcommand{\blno}{EGLV100170050579}
\newcommand{\bldt}{}
\newcommand{\rno}{\hspace{7em} / \hspace{4em}}
\newcommand{\rdt}{\hspace{2em}-12-21}
...
\newcommand{\impn}{\scml}
\newcommand{\impadd}{SHAFIPUR, KALIAKAIR, GAZIPUR-1751}
...
\newcommand{\san}{BARIDHI SHIPPING LINES LTD.}
\newcommand{\sad}{3/F HRC BHABAN, 64-66 AGRABAD C/A, CHITTAGONG}
...
\newcommand{\riskbondt}{১৪,৪০,০০০/-}
\newcommand{\riskbondg}{১০০০/-}
\newcommand{\consh}{
\noindent{
\begin{tabular}{|l|l|l|l|l|}
\hline
\textbf{EMCU9463106}{\cond}
&
\textbf{EITU9170927}{\cond}
&
\textbf{HMCU9070307}{\cond}
&
\textbf{TRHU6154527}{\cond}
&
\textbf{EMCU9670823}{\cond}
\\
\hline
\textbf{IMTU9022347}{\cond}
&
\textbf{EISU8516945}{\cond}
&
\textbf{HMCU9045161}{\cond}
&
\textbf{HMCU9049090}{\cond}
&
\textbf{}
\\
\hline
...
\\
\footnotesize{সহকারী/ডেপুটি কমিশনার অব কাস্টমস এর পক্ষে}
\\
\footnotesize{কাস্টম হাউস, চট্টগ্রাম।}
\\
\scriptsize{{\rodt}}
