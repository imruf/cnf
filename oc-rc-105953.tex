...
\newcommand{\beno}{C-105953}
\newcommand{\bedt}{17.01.22}
\newcommand{\rotno}{2022/273}
\newcommand{\pack}{STC:3,000 BALES}
\newcommand{\conno}{$\boldsymbol{19}$}
\newcommand{\co}{INDIA}
\newcommand{\vessel}{MV. CAPE MONTEREY}
\newcommand{\fdt}{\hspace*{3em} তারিখ: \hspace{2.4em}/০১/২২}
\newcommand{\frbdt}{তারিখ: \hspace{2.4em}/০১/২২}
\newcommand{\good}{RAW COTTON}
\newcommand{\depo}{...................................., DEPOT, CHITTAGONG}
\newcommand{\rdepo}{..................................., DEPOT, CHITTAGONG}
\newcommand{\blno}{GOSUBOM6338003}
\newcommand{\bldt}{}
\newcommand{\rno}{R-\hspace{10em}}
\newcommand{\rdt}{\hspace{2em}-01-22}

\newcommand{\impn}{\scml}
\newcommand{\impadd}{\scmla}
\newcommand{\impreg}{\eireg}

\newcommand{\san}{\hspace*{20em}}
\newcommand{\sad}{\hspace*{20em}}

\newcommand{\rodt}{তারিখ: \hspace{2.0em}/০১/২০২২ ইং}
\newcommand{\robdt}{\hspace{2.0em}/০১/২০২২ ইং}
\newcommand{\letterdt}{তারিখ: \hspace{3.0em}/০১/২০২২ ইং}
...
\newcommand{\riskbonddate}{\hspace{2em}/০১/২২ খ্রি:}
\newcommand{\riskbondt}{৩০,৪০০০০/-}
...
\hline
\textbf{TCNU4871192}{\cond}
&
\textbf{TCNU4048667}{\cond}
&
\textbf{TGBU9299351}{\cond}
&
\textbf{DFSU6495256}{\cond}
&
\textbf{JZPU8028424}{\cond}
\\
\hline
\textbf{TRHU8344418}{\cond}
&
\textbf{GAOU6092833}{\cond}
&
\textbf{BSIU9685356}{\cond}
&
\textbf{FSCU8151511}{\cond}
&
\textbf{GAOU6099627}{\cond}
\\
\hline
\textbf{TEMU7463445}{\cond}
&
\textbf{TCNU4858992}{\cond}
&
\textbf{TCKU7355106}{\cond}
&
\textbf{KSSU1000145}{\cond}
&
\textbf{CAIU8260921}{\cond}
\\
\hline
\textbf{TLLU4595789}{\cond}
&
\textbf{SEGU5756031}{\cond}
&
\textbf{TEMU6767084}{\cond}
&
\textbf{TLLU4581574}{\cond}
&
\textbf{}
\\
\hline
