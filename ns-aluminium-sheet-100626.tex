...
\newcommand{\fileno}{নথি নং - ১২৮৭/এপি/সেকশন-৮(এ)/২০২১-২০২২}
\newcommand{\product}{JAMUNA FAN}
\newcommand{\good}{ALUMINIUM SHEET SIZE (1.15*1150*2380 MM}
\newcommand{\pkg}{12 PKG=26,000.00 KG}
\newcommand{\co}{CHINA}
\newcommand{\coship}{CHINA}
\newcommand{\vessel}{MV. MAEERSK QUINZHOU}
\newcommand{\blno}{292307948}
\newcommand{\bldt}{28.12.2021}
\newcommand{\beno}{C-100626}
\newcommand{\bedt}{16.01.2022}
\newcommand{\lcno}{0000088821020131}
\newcommand{\lcdt}{12.12.21}
\newcommand{\lcano}{363751}
\newcommand{\lcadt}{\lcdt}
\newcommand{\lienbank}{ISLAMI BANK BANGLADESH LTD.}
\newcommand{\invno}{BK-JMA20211217}
\newcommand{\invdt}{17.12.2021}
...
\newcommand{\crfdt}{}
\newcommand{\ircno}{২৬০৩২৬১২০৫১৫০২০}
\newcommand{\ircrenewdt}{৩০.০৬.২০২২}
\newcommand{\musokr}{}
\newcommand{\hscode}{76061210}
\newcommand{\price}{US\$ 81,120.00}
\newcommand{\menifest}{2022/59}
...
উক্ত BIN -এ
আলোচ্য প্রতিষ্ঠানটির
ব্যবসার প্রকৃতি
Major Area of Economic Activity: Manufacturing, Imports
উল্লেখ আছে, যা NBR এর ওয়েবসাইট
...
পূর্ববর্তী মাসের {\musokr} দাখিলপত্র
...
B/E এর ঘোষণা মোতাবেক ALUMINUM SHEET পণ্যের নাম
উল্লেখ রয়েছে।
\\
\end{minipage}
\begin{minipage}[t]{0.05\linewidth}
...
এর বিধি-৪ অনুযায়ী পণ্যচালানটি প্রস্তাবিত মূল্যে শুল্কায়নযোগ্য।
\\
\end{minipage}
\begin{minipage}[t]{0.05\linewidth}
% at
...
বিধায় {\cpcfzo} -তে নোট অনুচ্ছেদ-৬ এর প্রকৃত H.S Code
