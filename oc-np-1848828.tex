...
\newcommand{\beno}{C-1848828}
\newcommand{\bedt}{17.11.2021}
\newcommand{\rotno}{2021/5371}
\newcommand{\pack}{STC:294 REEL}
\newcommand{\conno}{$\boldsymbol{04}$}
\newcommand{\co}{BELARUS}
\newcommand{\vessel}{MV.X-PRESS LHOTSE}
...
\newcommand{\ircno}{২৬০৩২৬১১১৩০৮১২০}
\newcommand{\san}{TRANSMARINE LOGISTICS LTD}
\newcommand{\sad}{B.M.Heights(4th Flr), 318, SK. Mujib Road, Agrabad C/A, Chattogram.}
...
\newcommand{\riskbondt}{৬,৪০,০০০/-}
\newcommand{\riskbondg}{৫০০/-}
\newcommand{\consh}{
\begin{tabular}{|l|l|l|l|}
\hline
\textbf{SEGU6071166}{\cond}
&
\textbf{TCNU3057216}{\cond}
&
\textbf{TGBU5508767}{\cond}
&
\textbf{TGBU5550514}{\cond}
\\
\hline
\end{tabular}
}
...
প্রতিষ্ঠান। যার আইআরসি সংখ্যা {\ircno}।
