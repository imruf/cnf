...
\newcommand{\beno}{C-356624}
\newcommand{\bedt}{20.02.2022}

\newcommand{\stc}{STC:1,300.00 BAGS}
...
\newcommand{\vessel}{MV.X-PRESS NUPTSE}
\newcommand{\blno}{YMLUS515003215}
\newcommand{\bldt}{}
\newcommand{\rotno}{2022/881}

%\newcommand{\rno}{R-\hspace{10em}}
\newcommand{\rno}{R-399222}

%\newcommand{\rdt}{\hspace{2em}-02-2022}
\newcommand{\rdt}{23-02-2022}
...
\newcommand{\riskbonddate}{ ২৭/০২/২০২২ খ্রি:}

%\newcommand{\riskbondno}{......................}
\newcommand{\riskbondno}{৪১২৯৫}

\newcommand{\riskbondtk}{৬,৪০,০০০/-}
...
\newcommand{\conno}{$\boldsymbol{04\times 40^\prime}$}
...
\hline
\textbf{FCIU7632133}{\condf}
&
\textbf{TCNU3664061}{\condf}
&
\textbf{YMMU6207749}{\condf}
&
\textbf{YMMU6413971}{\condf}
\\
\hline
\end{tabular}
}
