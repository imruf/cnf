...
\newcommand{\fileno}{নথি নং- \hspace{5em}/স্টাফ/কাস/০৬-০৭/অংশ-২}
...
\newcommand{\pack}{217 PKG}
\newcommand{\good}{COMPRESSOR}
\newcommand{\co}{CHINA}
\newcommand{\depo}{}
\newcommand{\rdepo}{CCTCL, DEPOT, CHITTAGONG}
\newcommand{\vessel}{MV. MCC CEBU}
\newcommand{\rotno}{2021/4288}
\newcommand{\blno}{SHWWSE210916506}
\newcommand{\beno}{C-1691243}
\newcommand{\bedt}{21.10.2021}
\newcommand{\rno}{R-1792574 \hspace{14.3em}}
\newcommand{\rdt}{28-10-21}
...
\newcommand{\impn}{JAMUNA ELECTRONICS AND AUTOMOBILES LTD.}
\newcommand{\cnfn}{SHAMEEM SPINNING MILLS LTD.}
\newcommand{\cnfadd}{92,HIGH LEVEL ROAD, LALKHAN BAZAR, CHITTAGONG}
\newcommand{\impadd}{Sinabha, Kaliakoir, Gazipur, 1750, BD}
% smml
...
\newcommand{\san}{MAERSK BANGLADESH LIMITED}
\newcommand{\sad}{Aziz Court (6th and 7th Floor), 88-90 Agrabad CA, Chattogram-4100.}
...
\begin{tabular}{|c|c|}
\hline
(01) \textbf{MSKU2190501} {\cond}
&
(02) \textbf{MRKU8096208} {\cond}
&
(03) \textbf{MSKU3316750} {\cond}
&
(04) \textbf{MSKU4327110} {\cond}
\\
\hline
(05) \textbf{MRKU9268019} {\cond}
&
(06) \textbf{MSKU5434978} {\cond}
&
(07) \textbf{MSKU7132745} {\cond}
&
(08) \textbf{HASU1386933} {\cond}
\\
\hline
\end{tabular}
}
