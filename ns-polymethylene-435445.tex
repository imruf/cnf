...
\newcommand{\fileno}{নথি নং - ৩৬১৬/এপি/সেকশন-৭(বি)/২০২১-২০২২}
\newcommand{\nfilenou}{\underline{\fileno}}

\newcommand{\product}{Refrigerator}
\newcommand{\good}{POLYMETHYLENEPOLYPHENYLENE ISOCYANATE (WANNATE PM2010)}
\newcommand{\pkg}{400 PKG=100,000.00 KG}
\newcommand{\hscode}{39093110}
\newcommand{\price}{US\$ 250,000.00}

\newcommand{\co}{CHINA}
\newcommand{\coship}{CHINA}

\newcommand{\vessel}{MV. MAERSK QUINZHOU}

\newcommand{\blno}{216125494}
\newcommand{\bldt}{01.30.22}

\newcommand{\beno}{C-435445}
\newcommand{\bedt}{03.03.2022}
\newcommand{\menifest}{2022/775}

\newcommand{\lcno}{0000174122020019}
\newcommand{\lcdt}{12.01.2022}
\newcommand{\lcano}{274585}
\newcommand{\lcadt}{\lcdt}
\newcommand{\lienbank}{MERCANTILE BANK LTD.}

\newcommand{\invno}{SG1489831BD}
\newcommand{\invdt}{31.01.2022}
...
পণ্যের শুল্কায়িত সর্বনিম্ন যে বিনিময় মূল্য পাওয়া যায়, উক্ত মূল্য অপেক্ষা ঘোষিত মূল্য কম হওয়ায়
শুল্ক মূল্যায়ন (আমদানি পণ্যের মূল্য নির্ধারণ) বিধিমালা,
২০০০ (এসআরও নং- ৫৭/আইন/২০০০/১৮২১/শুল্ক, তারিখ: ২৩/০২/২০০০)
এর বিধি- ৫ অনুযায়ী আলোচ্য পণ্যচালানটি প্রস্তাবিত
...
বিধায় পণ্যচালানটি
{\cpcfzn}-তে নোট অনুচ্ছেদ-৫ এর প্রস্তাবিত H.S Code
ও মূল্যে শুল্কায়ন অনুমোদন দেয়া যেতে পারে।
\\
\\
